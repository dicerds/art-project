...
export const interests = [
  {
    title: 'Passive & Sustainable Design',
    body: 'Orientation, cross-ventilation, and shading studied before mechanical systems—buildings that stay comfortable with less energy.',
  },
  {
    title: 'Vernacular Material Research',
    body: 'Studying local timber, brick, and stone traditions, and how they can be detailed for a modern lifespan.',
  },
  {
    title: 'Physical Model-Making',
    body: 'Every project begins as a maket. Working in the physical model reveals proportion and shadow that a screen hides.',
  },
  {
    title: 'Daylight & Spatial Studies',
    body: 'Mapping how light moves through a space across the day—the quality most clients feel but rarely name.',
  },
  {
    title: 'Urban Sketching & Travel',
    body: 'Sketchbook in hand across Southeast Asia, recording how cities and courtyards actually get used.',
  },
  {
    title: 'Teaching & Mentoring',
    body: 'Occasional design-studio critic and mentor to junior architects—teaching keeps the fundamentals sharp.',
  },
];
